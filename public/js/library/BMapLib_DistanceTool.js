...
(function() {
	...
	var d = BMapLib.DistanceTool = function(f, e) {
		...
		this._opts = c.extend(c.extend(this._opts || {}, {
			...
			opacity: 0.8,
			lineStyle: "solid",
			cursor: "BaiduAPI/images/ruler.cur",
			secIcon: null,
			closeIcon: null
		}), e);
		...
		this._styles = {
			BMapLib_diso: "height:17px;width:5px;position:absolute;background:url(BaiduAPI/images/dis_box_01.gif) no-repeat left top",
			BMapLib_disi: "color:#7a7a7a;position:absolute;left:5px;padding:0 4px 1px 0;line-height:17px;background:url(BaiduAPI/images/dis_box_01.gif) no-repeat right top",
	...
	d.prototype._addSecPoint = function(g) {
		var f = this._opts.secIcon ? this._opts.secIcon : new BMap.Icon("BaiduAPI/images/mapctrls.png", new BMap
			.Size(11, 11), {
	...
	d.prototype._setCursor = function(f) {
		var e = /webkit/.test(navigator.userAgent.toLowerCase()) ? "url(" + this._opts.cursor + ") 3 6, crosshair" : "url(" +
	...
	d.prototype._formatSegLabel = function(e, f) {
		...
		e.setContent("<span style='" + this._styles.BMapLib_diso + "'><span style='" + this._styles.BMapLib_disi + "'>" + f +
			"</span></span>")
	};
	d.prototype._processLastOp = function() {
		...
		var m = this._opts.closeIcon ? this._opts.closeIcon : new BMap.Icon("BaiduAPI/images/mapctrls.gif",
			new BMap.Size(12, 12), {
	...
	d.prototype._formatTitle = function(g, l, e, i) {
		...
		if (g == 1) {
			...
			k.push("<span>\u603b\u957f\uff1a<span style='" + this._styles.BMapLib_disBoxDis + "'>" + f + "</span>" + j +
				"</span><br />");
	...
	d.prototype._updateInstDis = function(g, e) {
		...
		if (g) {
			var h = [];
			h.push("<span>\u603b\u957f\uff1a<span style='" + this._styles.BMapLib_disBoxDis + "'>" + e + "</span>" + i +
				"</span><br />");
	...
	var a = {
		_map: null,
		_html: "<div style='background:transparent url(BaiduAPI/images/blank.gif);position:absolute;left:0;top:0;width:100%;height:100%;z-index:1000' unselectable='on'></div>",
		_maskElement: null,
		_cursor: "default",
		_inUse: false,
		show: function(e) {
