...
(function() {
	...
	c.prototype.getOffset = function() {
		...
		_getCloseIcon: function() {
			var d = "<img src='" + this._opts.closeIconUrl + "' align='right' style='width:20px;height:20px;position:absolute;right:0px;cursor:pointer;margin:" + this._opts.closeIconMargin + "'/>";
			return d
		},
